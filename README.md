...
•  Seamless time-series visualization of how users’ lifestyle habits changed over time as participants in a
lifestyle modification program (Flask framework, D3.js) http://habits-program.herokuapp.com

•  Visualization of user behavior on Jana Care’s Food Habits Android App (MongoDB backend, Flask
framework, D3.js) http://janacare-dashboard.herokuapp.com

•  Harvard Labs Search Interface: (Summer 2012). Developed a search interface for Harvard students, which queries a lab database using AJAX. 
